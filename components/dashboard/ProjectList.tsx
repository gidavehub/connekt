        ...
        <div className="bg-white/50 dark:bg-zinc-900/50 backdrop-blur-lg border border-white/20 dark:border-white/5 rounded-2xl p-6 h-[420px] overflow-y-auto custom-scrollbar relative">
            ...
            <div className="space-y-3">
                {projects.map((project, i) => (
                    <div key={project.id} onClick={() => openProjectModal(project)} className="cursor-pointer flex items-start justify-between p-3 rounded-xl bg-gray-50 dark:bg-zinc-800/50 hover:bg-gray-100 dark:hover:bg-zinc-800 transition-colors group">
